    ...
    for f1 in files:
        ...
        for line in fable_texts.readlines():
            ...
            for seed in range(nseed):
                ...
                point_cloud = []
                # prompts = open(f"aesop/prompt/{file_name}.txt", "a")
                # prompts.write(init_prompt)
                output_data = []
                # text_embedding = run_panic.calculate_embedding("text", init_prompt)
                output_data.append(
                    {
                        "seq_no": 0,
                        "type": "text",
                ...
                with open(f"aesop/embedding/{file_name}.json", "w") as f2:
                    json.dump(output_data, f2, indent=4, sort_keys=True)
                ...
                # point_cloud = np.loadtxt(f"aesop/embedding/{file_name}.txt", dtype=float)
